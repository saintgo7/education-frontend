...
export const metadata: Metadata = {
  title: 'Page Example 13',
  description: 'Next.js App Router Page Example 13',
};
 ...
 */
export default async function Page13({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/13`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-13">
      <h1>Page Example 13</h1>
