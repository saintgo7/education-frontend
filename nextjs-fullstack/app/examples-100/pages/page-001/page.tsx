...
export const metadata: Metadata = {
  ...
  description: 'Next.js App Router Page Example 1',
};
 ...
 */
export default async function Page1({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/1`, {
