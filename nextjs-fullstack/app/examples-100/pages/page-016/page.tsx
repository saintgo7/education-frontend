...
export const metadata: Metadata = {
  title: 'Page Example 16',
  description: 'Next.js App Router Page Example 16',
};
 ...
 */
export default async function Page16({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/16`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-16">
      <h1>Page Example 16</h1>
