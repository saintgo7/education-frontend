...
export const metadata: Metadata = {
  title: 'Page Example 15',
  description: 'Next.js App Router Page Example 15',
};
 ...
 */
export default async function Page15({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/15`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-15">
      <h1>Page Example 15</h1>
