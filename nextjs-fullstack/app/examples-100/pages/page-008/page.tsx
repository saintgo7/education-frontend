...
export const metadata: Metadata = {
  title: 'Page Example 8',
  description: 'Next.js App Router Page Example 8',
};
 ...
 */
export default async function Page8({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/8`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-8">
      <h1>Page Example 8</h1>
