...
export const metadata: Metadata = {
  title: 'Page Example 7',
  description: 'Next.js App Router Page Example 7',
};
 ...
 */
export default async function Page7({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/7`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-7">
      <h1>Page Example 7</h1>
