...
export const metadata: Metadata = {
  title: 'Page Example 14',
  description: 'Next.js App Router Page Example 14',
};
 ...
 */
export default async function Page14({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/14`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-14">
      <h1>Page Example 14</h1>
