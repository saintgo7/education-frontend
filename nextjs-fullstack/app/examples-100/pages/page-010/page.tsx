...
export const metadata: Metadata = {
  title: 'Page Example 10',
  description: 'Next.js App Router Page Example 10',
};
 ...
 */
export default async function Page10({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/10`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-10">
      <h1>Page Example 10</h1>
