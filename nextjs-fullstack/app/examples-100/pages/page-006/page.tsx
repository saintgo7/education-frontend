...
export const metadata: Metadata = {
  title: 'Page Example 6',
  description: 'Next.js App Router Page Example 6',
};
 ...
 */
export default async function Page6({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/6`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-6">
      <h1>Page Example 6</h1>
