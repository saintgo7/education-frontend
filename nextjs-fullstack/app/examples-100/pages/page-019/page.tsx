...
export const metadata: Metadata = {
  title: 'Page Example 19',
  description: 'Next.js App Router Page Example 19',
};
 ...
 */
export default async function Page19({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/19`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-19">
      <h1>Page Example 19</h1>
