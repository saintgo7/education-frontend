...
export const metadata: Metadata = {
  title: 'Page Example 18',
  description: 'Next.js App Router Page Example 18',
};
 ...
 */
export default async function Page18({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/18`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-18">
      <h1>Page Example 18</h1>
