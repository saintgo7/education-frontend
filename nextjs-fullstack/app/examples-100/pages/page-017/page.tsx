...
export const metadata: Metadata = {
  title: 'Page Example 17',
  description: 'Next.js App Router Page Example 17',
};
 ...
 */
export default async function Page17({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/17`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-17">
      <h1>Page Example 17</h1>
