...
export const metadata: Metadata = {
  title: 'Page Example 11',
  description: 'Next.js App Router Page Example 11',
};
 ...
 */
export default async function Page11({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/11`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-11">
      <h1>Page Example 11</h1>
