...
export const metadata: Metadata = {
  ...
  description: 'Next.js App Router Page Example 9',
};
 ...
 */
export default async function Page9({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/9`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-9">
      <h1>Page Example 9</h1>
