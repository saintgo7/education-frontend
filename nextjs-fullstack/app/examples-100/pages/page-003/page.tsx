...
export const metadata: Metadata = {
  ...
  description: 'Next.js App Router Page Example 3',
};
 ...
 */
export default async function Page3({ params, searchParams }: PageProps) {
  // Async data fetching in Server Component
  const data = await fetch(`https://api.example.com/data/3`, {
    next: { revalidate: 3600 },
  }).then(res => res.json()).catch(() => ({ items: [] }));

  return (
    <div className="page-3">
      <h1>Page Example 3</h1>
