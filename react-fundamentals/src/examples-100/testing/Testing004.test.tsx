...
interface Counter4Props {
  initialCount?: number;
  step?: number;
}

function Counter4({ initialCount = 0, step = 1 }: Counter4Props) {
...
describe('Counter4', () => {
  it('should render with initial count', () => {
    render(<Counter4 initialCount={5} />);
    expect(screen.getByTestId('count')).toHaveTextContent('Count: 5');
  });

  it('should increment count when increment button is clicked', () => {
    render(<Counter4 initialCount={0} step={2} />);
  ...
  it('should decrement count when decrement button is clicked', () => {
    render(<Counter4 initialCount={10} step={3} />);
  ...
  it('should maintain history of counts', () => {
    render(<Counter4 initialCount={0} step={1} />);
